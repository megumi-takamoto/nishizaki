...
$site_top = "http://www.nishizakiryu.com/sp/";
...
$require = array('お問合せ内容','ご希望','お名前','メールアドレス','電話番号','住所','年齢');
...
<title>平成26年度東京の学校見学会：確認画面</title>
<link rel="stylesheet" type="text/css" media="all" href="style_s.css">
...
<div id="formWrap">
<?php if($empty_flag == 1){ ?>
<h1>平成26年度東京の学校見学会<br>参加申し込みフォーム確認画面</h1>
<h4><p style="color:#F00">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p></h4>
...
<p>&nbsp;</p>
<p align="center" style="font-size:10px">© 西崎流筑紫会 All rights reserved.</p>
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>平成26年度東京の学校見学会：完了画面</title>
...
<?php }else{ ?>
<p>&nbsp;</p>
<div align="center"><p style="font-size:15px;">送信は正常に完了しました。</p></div>  
<p>&nbsp;</p>
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#ffffff;text-decoration:none" href="http://kengakukai.kyoeiad.net/" target="_blank">- 学校見学 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
